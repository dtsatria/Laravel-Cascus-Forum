<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 dark:bg-gray-800">
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
      <div class="flex items-center justify-between">
        <a class="flex-none text-3xl font-semibold dark:text-white" href="#">Cascus.</a>
        <div class="sm:hidden">
      ...
      <div id="navbar-with-collapse" class="hidden basis-full grow sm:block">
        ...
        <div class="flex flex-col items-center gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
          @auth
          ...
          <a class="font-medium text-sm text-black hover:text-blue-600  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('logout') }}"
